...
public class CustomAddAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CustomAddAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_VACANT:
                view = inflater.inflate(R.layout.allrooms_edit_vacant_item, parent, false);
                return new VacantViewHolder(view);
            case VIEW_TYPE_BOOKED:
                view = inflater.inflate(R.layout.allrooms_edit_booked_item, parent, false);
